                            ...
                            {filteredProducts.map((product, index) => {
                                ...
                                return (
                                    <div key={index} className="bg-gray-50 rounded-md border border-blue-200 p-4 shadow-md">
                                        ...
                                        <div className="flex gap-6 justify-around items-center mb-2 border border-gray-400 rounded-md px-2 p-1">
                                            <p className="text-sm md:text-lg font-medium text-gray-700">Price</p>
                                            <p className="text-sm">{product.price}<span className="text-green-500 text-sm font-light md:font-medium">PKR</span></p>
                                        </div>
